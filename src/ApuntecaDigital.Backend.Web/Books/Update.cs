  ...
  : Endpoint<UpdateBookRequest, UpdateBookResponse>
{
  ...
  {
    var result = await _mediator.Send(new UpdateBookCommand(request.Id, request.Title!, request.Author!, request.Isbn!), cancellationToken);
    ...
    if (queryResult.IsSuccess)
    {
      ...
      Response = new UpdateBookResponse(new BookRecord(dto.Id, dto.Title, dto.Author, dto.Isbn));
      return;
    }
  }
}
