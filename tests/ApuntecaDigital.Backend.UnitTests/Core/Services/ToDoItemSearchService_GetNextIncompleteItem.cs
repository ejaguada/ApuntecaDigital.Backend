...
using ApuntecaDigital.Backend.Core.ProjectAggregate;
using ApuntecaDigital.Backend.Core.Services;
using ApuntecaDigital.Backend.SharedKernel.Interfaces;
using Moq;
using Xunit;

namespace ApuntecaDigital.Backend.UnitTests.Core.Services
{
